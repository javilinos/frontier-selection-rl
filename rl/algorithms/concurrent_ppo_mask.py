...
class MaskablePPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        super().__init__(
            MaskableMultiInputActorCriticPolicy,  # type: ignore[arg-type]
            env,
        ...
        if _init_setup_model:
            self._setup_model(policy=policy)

    def _setup_model(self, policy) -> None:
    ...
    def train(self) -> None:
        ...
        # Switch back to eval mode in case other agent is in rollout phase
        self.policy.set_training_mode(False)
