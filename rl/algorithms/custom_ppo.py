...
class PPO(OnPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        self.policy: ActorCriticPolicy = self.policy_class(  # type: ignore[assignment]
    ...
    def collect_rollouts(
            ...
            with th.no_grad():
                ...
                for frontier_feature in last_frontier_features:
                    features_list.append(obs_as_tensor(
                        frontier_feature, self.device).unsqueeze(0))  # Frontier features
                obs_tensor = obs_as_tensor(self._last_obs, self.device)  # Image

                # Shape (batch_size, num_candidates, candidate_feature_dim)
                # features_tensor = th.stack(features_list, dim=1)
        ...
        with th.no_grad():
            ...
            values = self.policy.predict_values(obs_as_tensor(
                new_obs, self.device), features_list)  # type: ignore[arg-type]
    ...
    def learn(  # type: ignore[override]
        ...
        while self.num_timesteps < total_timesteps:
            ...
            #     print(f"Parameter {name} is shared: {param.is_shared()}")
            # th.cuda.empty_cache()
    ...
    def load(  # noqa: C901
        ...
        **kwargs,
        ...
        sys.path.append(os.path.abspath(
            '/home/javilinos/Desktop/as2_projects/project_rl/rl/algorithms/policies'))
